  ...
  return (
    <Sidebar collapsible="icon" className="relative">
      ...
      <button
        ...
        className="hidden md:flex absolute top-4 -right-3 z-50 h-7 w-6 items-center justify-center rounded-r-md bg-sidebar-accent border border-l-0 border-sidebar-border text-sidebar-foreground/60 hover:text-sidebar-foreground hover:bg-sidebar-primary/20 transition-all duration-200 shadow-sm"
